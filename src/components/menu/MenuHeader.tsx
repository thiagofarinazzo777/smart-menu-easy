...
export function MenuHeader({ config, isOpen, nextOpenInfo, searchQuery, onSearchChange }: MenuHeaderProps) {
  ...
  return (
    <>
      {/* Top bar — logo + name left, search right */}
      <div className="w-full bg-background border-b">
        <div className="max-w-md mx-auto px-4 py-2.5 flex items-center gap-3">
          ...
          <span className="text-sm font-bold truncate whitespace-nowrap">{config?.name || "Ouro & Brasa"}</span>
          ...
          <div className="flex-1 min-w-0 ml-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm bg-muted/50 text-foreground placeholder:text-muted-foreground border border-border focus:outline-none focus:ring-2 focus:ring-primary/30"
